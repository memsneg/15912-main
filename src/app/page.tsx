...
const HOME_REVIEWS = [
  ...
  { text: "اتصلت على 15912 ووصل الفني في نفس اليوم. أنصح بالتعامل معهم.", name: "سارة ك.", location: "مدينة نصر" },
...
export default function HomePage() {
  return (
    <>
      <Hero
        h1="صيانة أجهزة منزلية — خط ساخن 15912"
        subheadline="صيانة LG وكريازي وأريستون ووايت ويل وزانوسي في القاهرة والدقهلية والبحيرة والغربية وكفر الشيخ. خدمة منزلية، قطع غيار أصلية، وضمان بعد الصيانة."
      />
